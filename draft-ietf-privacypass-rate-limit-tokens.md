...
Anonymous Origin ID = HKDF(secret=Client Secret, salt="", info=(Origin Name, Issuer name)).
...
The Attester then stores the Anonymous Issuer Origin ID alongside the state for the Anonymous
